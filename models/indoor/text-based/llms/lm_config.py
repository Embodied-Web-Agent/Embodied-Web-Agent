...
def construct_llm_config(args: argparse.Namespace) -> LMConfig:
    ...
    if args.provider == "openai":
        llm_config.gen_config["temperature"] = 0
        ...
        # llm_config.gen_config["max_completion_tokens"] = args.max_tokens
        ...
        llm_config.gen_config["max_output_tokens"] = args.max_tokens
