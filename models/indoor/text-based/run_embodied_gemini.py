...
def test(
    ...
    for config_file in config_file_list:
        ...
        results = {"score": score, "state_evaluator": states, "actions": trajectory[1::2], "observations": observations}

        with open(f"results_gemini/{config_file.split('/')[-1]}_record.json", "w") as f:
